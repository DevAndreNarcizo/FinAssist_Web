  ...
  return (
    <div className="flex flex-col gap-6 h-full">
      ...
      <Card>
        ...
        <p className="text-4xl font-bold text-white">{formatCurrency(netWorth, language)}</p>
      </Card>
      
      <Card className="flex-grow flex flex-col">
        <h2 className="text-sm font-medium text-gray-400 mb-4">{translations.spendingAnalysis[language]}</h2>
        <div className="flex-grow h-64 cursor-pointer" onClick={() => setActiveCategoryFilter(null)} title={translations.clickToClear[language]}>
