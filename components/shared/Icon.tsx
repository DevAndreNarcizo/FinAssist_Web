...
export const TrophyIcon = ({ className }: { className?: string }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 11l3-3m0 0l3 3m-3-3v8m0-13.5a9 9 0 110 18 9 9 0 010-18z"></path><path d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l-3 3m6 0l-3-3m-3 18v-6a3 3 0 00-3-3H9a3 3 0 00-3 3v6m12 0v-6a3 3 0 00-3-3h-1.5a3 3 0 00-3 3v6m6 0h-6" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
);
